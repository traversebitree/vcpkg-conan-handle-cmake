...
if(USE_PROXY)
    if(PROJ_OS_WINDOWS)
        ...
        string(REGEX REPLACE "github\\.com \"" "ghproxy.com \"/github.com" TEMP_FILE_STRING ${TEMP_FILE_STRING})
...
if(EXISTS "${vcpkg_SOURCE_DIR}/vcpkg.exe" OR EXISTS "${vcpkg_SOURCE_DIR}/vcpkg")
    message(STATUS "BUILDED!")
else()
