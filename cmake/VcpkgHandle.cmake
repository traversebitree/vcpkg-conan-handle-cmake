...
if((_MACHINE_HARDWARE_NAME_LOWER MATCHES "^arm"
    ...
    OR _MACHINE_HARDWARE_NAME_LOWER MATCHES "^riscv"
   )
...
if(CMAKE_GENERATOR MATCHES "MinGW")
  if(_MACHINE_HARDWARE_NAME_LOWER MATCHES "^amd64")
    set(_VCPKG_HOST_PLAT "x64")
  elseif(_MACHINE_HARDWARE_NAME_LOWER MATCHES "^x86")
    set(_VCPKG_HOST_PLAT "x86")
  elseif(_MACHINE_HARDWARE_NAME_LOWER MATCHES "^arm64")
    set(_VCPKG_HOST_PLAT "arm64")
  endif()
  set(MINGW TRUE PARENT_SCOPE)
  set(VCPKG_HOST_TRIPLET "${_VCPKG_HOST_PLAT}-mingw-dynamic" PARENT_SCOPE)
endif()
